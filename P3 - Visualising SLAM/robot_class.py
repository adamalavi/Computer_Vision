...
class robot:
    ...
    def sense(self):
        ...
        for i in range(self.num_landmarks):
            ...
            dx = self.landmarks[i][0] - self.x + random_noise
            dy = self.landmarks[i][1] - self.y + random_noise
            
            if fabs(dx)<=self.measurement_range and fabs(dy)<=self.measurement_range:
